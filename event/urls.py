...
from .views import EventViewSet, TimeSlotView, AbsenceViewSet, DoctorScheduleViewSet, OfficeViewSet, VisitTypeViewSet, TagsViewSet, AvailableAssistantsView, CheckRepetitionEvents, EventCalendarViewSet
